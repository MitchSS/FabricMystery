...
workspace = 'Fabric Mystery Demo' # Enter the name or ID of the workspace in which the semantic model resides
source = 'AetherLH' # The name or ID of the lakehouse/warehouse
source_type = "Lakehouse" # Can either be 'Lakehouse' or 'Warehouse'
source_workspace = 'Fabric Mystery Demo' # Enter the name or ID of the workspace in which the lakehouse/warehouse exists
